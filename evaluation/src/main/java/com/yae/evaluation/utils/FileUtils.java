...
public class FileUtils {
    ...
    public static String getSubmissionFilePath(String userId, String assignmnentId, String fileName){
        String filePath = FILE_BASE_PATH;
        filePath += (userId + "/" + assignmnentId + "/" + fileName);
        return filePath;
    }

    public static String getTempFilePath(String userId, String fileName) throws IOException{
